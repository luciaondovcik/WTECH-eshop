                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-primary btn-block waves-effect waves-light" onclick="window.location.href='thankyou.html';"><strong>Dokonči</strong></button>
                                <button type="button" class="btn btn-block" onclick="window.location.href='checkout.html';">Krok späť</button>
                            </div>
                        </div>
                        <!-- Card -->
                    </div>
