...
@section('main-content')
    <div class="bg-light py-3">
        <div class="container">
            <div class="row">
                <div class="col-md-12 mb-0"><a href="index.html">Domov</a> <span class="mx-2 mb-0">/</span> <a href="cart.html">Košík</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Dodacie údaje</strong></div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-8 mb-5 mb-md-0">
                    ...
                    <div class="p-3 p-lg-4 border">
                        ...
                        <div class="form-group">
                            <label for="c_create_account" class="text-black" data-toggle="collapse" href="#create_an_account" role="button" aria-expanded="false" aria-controls="create_an_account"><input type="checkbox" value="1" id="c_create_account"> Vytvoriť účet?</label>
